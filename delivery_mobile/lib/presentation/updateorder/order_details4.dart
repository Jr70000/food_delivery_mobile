...
import 'package:delivery_mobile/widgets/swipe_button2.dart';
          ...
          child: Stack(
            children: [
              ...
              Align(
                ...
                child: Padding(
                  padding:  const EdgeInsetsDirectional.fromSTEB(0, 0, 200, 0),
                  child: Text(
                    '100039',
                    style: FlutterFlowTheme.of(context).bodyMedium.override(
                          fontFamily: 'Readex Pro',
             ...
             const Align(
              ...
              Align(
                ...
                child: Padding(
                  padding: const EdgeInsetsDirectional.fromSTEB(0, 90, 0, 147),
                  child: Material(
                    color: Colors.transparent,
                    elevation: 2,
                    shape: RoundedRectangleBorder(
             ...
             const Padding(padding: EdgeInsetsDirectional.fromSTEB(0, 530, 0, 0),
              child:  SwipeButton(),)
            ],
          ),
        ),
