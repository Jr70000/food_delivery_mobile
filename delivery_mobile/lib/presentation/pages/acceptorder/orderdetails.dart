...
import 'package:delivery_mobile/models/Cordermodel.dart';
...
class _ComfirmorderpageWidgetState extends State<ComfirmorderpageWidget> {
  late ComfirmorderpageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ComfirmorderpageModel());
  }
                      ...
                      child: Stack(
                        children: [
                          ...
                          Opacity(
                            ...
                            child: Align(
                              alignment:
                                  const AlignmentDirectional(-0.84, -1.05),
                              child: Text(
                                'Restaurant Details',
                                style: FlutterFlowTheme.of(context).bodyMedium,
                              ),
                      ...
                      child: Stack(
                        children: [
                          ...
                          Opacity(
                            ...
                            child: Align(
                              alignment:
                                  const AlignmentDirectional(-0.34, 0.08),
                              child: Text(
